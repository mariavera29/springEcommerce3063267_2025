...
public class UsuarioController {
	...
	//obtener o listar las ordenes de compras
	@GetMapping("/compras")
	public String compras(Model model, HttpSession session) {
		//sesion de usuario o el idUsuario objeto de sesion
	...
	public String detalleCompra(@PathVariable Integer id, Model model, HttpSession session) {
		...
		model.addAttribute("detalles",orden.get().getDatalle());
		return "usiario/detallecompra";
	}
	@GetMapping("/cerrar")
